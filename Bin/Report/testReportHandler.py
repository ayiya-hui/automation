...
MAIL='<p>Test Name: $linkText-Tester:$localhostIp</p><p>http link: $link</p> <p> $report </p>'
...
class testReport:
    ...
    def __sendEmailout(self, data, name_test, run_version, recipt):
        import Libs.sendEmailHandler as sendEmailHandler
        mySmtp=sendEmailHandler.sendEmailHandler(recipt)
        mySmtp.sendEmail(data, name_test, run_version)
