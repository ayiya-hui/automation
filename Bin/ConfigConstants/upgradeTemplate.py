...
<html>
    <head>
        ...
        <title>Accelops Upgrade Test Result</title>
    </head>
    <body>
        <h3>$description</h3>
        <hr>
...
upgrade_desc="""Upgrade test is performed on System $server.\n
                Pre-Upgrade (Base) Version: $pre_version\n
                Post-Upgrade Version: $post_version\n
"""
