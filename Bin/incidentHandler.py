...
group_key='Group@'
add_test_rule='ruletest/test'
get_test_rule='ruletest/result?id=%s'
            ...
            for line in msgs:
                ...
                if rawSend:
                    if param.method=='netflow':
                        ...
                        temp_msg=msg.strip()
                    send_msg=GenerateRawIPData.getRawIpPacket(temp_msg, rept_ip, rept_ip, PORTS[param.method])
                else:
                    send_msg=msg
